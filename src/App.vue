<template>
        ...
        <div class="md:block">
          <nav aria-label="Global">
            <ul class="flex items-center gap-6 text-sm">
              ...
              <li>
                <router-link to="/team" class="items text-gray-500 hover:text-green transition-all">Team</router-link>
              </li>
  ...
  <router-view @add-to-cart="incrementCart" />
...
export default {
  data() {
    return {
      cartCount: 0, // State global pour le panier
    };
  },
  methods: {
    incrementCart() {
